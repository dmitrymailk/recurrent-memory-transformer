...
accel_config = {
    ...
    "deepspeed_config": {"deepspeed_config_file": None, "zero3_init_flag": True},
...
if args.bf16:
    ...
    precision = ""
# base_folder_path = "/home/jovyan/rmt/wip/accel_configs/exp/accelerate"
accel_folder_path = "/code/accel_configs/accelerate"
os.system(f"mkdir -p {accel_folder_path}")

accel_config_path = (
    f"{accel_folder_path}/deepspeed_" + precision + "tbs{}bs{}g{}c{}np{}.yaml"
)
...
# deepspeed_folder_path = "/home/jovyan/rmt/wip/accel_configs/exp/deepspeed"
deepspeed_folder_path = "/code/accel_configs/deepspeed"
os.system(f"mkdir -p {deepspeed_folder_path}")

deepspeed_config_path = (
    f"{deepspeed_folder_path}/0s2_" + precision + "tbs{}bs{}g{}c{}.json"
)
deepspeed_config_path = deepspeed_config_path.format(
    args.train_batch_size,
    args.train_micro_batch_size_per_gpu,
    args.gradient_accumulation_steps,
    args.gradient_clipping,
...
deepspeed_config["train_micro_batch_size_per_gpu"] = int(
    args.train_micro_batch_size_per_gpu
)
